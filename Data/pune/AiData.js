export const AiCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Advance Artificial Intelligence Course in Pune With",
      mTopPara: "Boost Your Professional Growth ",
      spanMTitleText: " Domain Specialization",
      mTopPara1: "To a Whole New Level",
      title: "Advance Artificial Intelligence Course in Pune",
    ...
    BoxShape: {
    title: "AI Certification Programs in Pune",
  ...
  syllabusDesc:"Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Artificial Intelligence Course in Pune sessions are covered practically with real-time industrial projects and case studies.",
  ...
  ProgramFee: {
    Emi: "₹ 9,342/month",
    Fee: "₹ 95,000 +GST",
    CourseFeeAndFinancing:"Artificial Intelligence Course Fee & Financing in Pune",
    para:"We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for AI Certification Course in Pune and offer avariety of financing options to make it more economical.",
  },
  Project: { project: "15+ Projects", domain: "7+", projectTitle:"Hands-on Projects in Pune" },
