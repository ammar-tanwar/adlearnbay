export const BusinessAnalyticsCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Business Analytics Course in Pune",
    ...
    BoxShape: {
      title: "Business Analytics Certification Programs in Pune",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Business Analytics Course in Pune sessions are covered practically with real-time industrial projects and case studies.",
    ...
    ProgramFee: {
      ...
      CourseFeeAndFinancing:
        "Business Analytics Course Fee & Financing in Pune",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Business Analytics Certification Course in Pune and offer a variety of financing options to make it more economical.",
    },
    Project: {
    ...
    CourseFees: {
      CourseFeeHead: "Business Analytics Course in Pune : Batch Details",
