export const DataAnalyticsCourseData = [
  {
    ...
    BoxShape: {
      title: "Data Analytic Certification Programs in Chennai",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Data Analytic Course in Chennai sessions are covered practically with real-time industrial projects and case studies.",
    ...
    ProgramFee: {
      Emi: "₹ 14,750/month",
      Fee: "₹ 75,000 +GST",
      CourseFeeAndFinancing: "Data Analytics Course Fee & Financing in Chennai",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Data Analytic Certification Course in Chennai and offer avariety of financing options to make it more economical.",
    },
    Project: {
      project: "8+ Projects",
      domain: "7+",
    ...
    CourseFee: {
      CourseFeeHead: "Data Analytics Course in Chennai : Batch Details",
