export const JobGuaranteeCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Data Science and AI Program in Chennai",
    ...
    BoxShape: {
      title: "100% Job Assistance Programs in Chennai",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All 100% Placement Assistance Course in Chennai sessions are covered practically with real-time industrial projects and case studies.",
    ...
    ProgramFee: {
      ...
      CourseFeeAndFinancing:
        "100% Placement Assistance Course Fee & Financing In Chennai",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for 100% Placement Assistance Course In Chennai and offer avariety of financing options to make it more economical.",
    },
    Project: {
    ...
    CourseFee: {
      CourseFeeHead:
        "100% Placement Assistance Course In Chennai: Batch Details",
