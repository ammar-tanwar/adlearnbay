export const demo = 
    ...
    export const demo1 = 
    {
        "Heading":"Learn Low Level System Design of an E-commerce website",
        "StartON":"STARTS ON :",
        "StartONT":" October 02, 2022 7:00 PM (IST)",
        "EndON":"ENDS ON : ",
        "EndONT":"October 02, 2022 10:00 PM (IST)",
        "Venue":"VENUE : ",
        "VenueO":"Online",
        "Duration":" DURATION : ",
        "DurationT":" 3 hours",
        ...
        "para1":"About this Masterclass",
        "paragraph1":"E-commerce applications are getting exceedingly popular in today’s fast-paced business environment. It takes more than excellent content distribution, robust checkout features, and top-notch SEO techniques to build a successful E-Commerce business. All of these factors are significant, but without a strong foundation—which is provided by the proper ecommerce website architecture—none of them will lead to scalability and growth for your online business. Hence System Design process is vital for creating efficient and user-friendly systems. It involves defining system elements like modules, architecture, components and their interfaces, as well as data, based on specified requirements.",

        "paragraph2":" Ready to deep dive into the field of System Design?",
        "paragraph2_1":"Prakhar Agrawal",
        "paragraph2_2":" is hosting a FREE Masterclass on",
        "paragraph2_3":" October 2nd at 7 PM ",
        "paragraph3":" to help bring clarity to architectural system design concepts. Register today to reserve your spot!",

        "para2":"Topics Covered In The Masterclass",

        "paragraph24":"Designing a Payment System",
        "paragraph4":"Designing a Delivery Process and Delivery Tracking",
        "paragraph5":"Design a Inventory Database",
        "paragraph5_1":"Elastic Search Architecture and Design Consideration",

        "para3":"What you will gain from this Masterclass",

        "paragraph6":"Learn about the Requirements of the system",
        "paragraph7":"Functional and Non-functional Requirements",
        "paragraph8":"E-Commerce Application’s Selling/Buying-End Architecture",
        ...
        "paragraph6_2":"SDEs Seeking Upskilling",
        "paragraph7_2":"SDEs Wishing to convert to product companies from Service companies",
        "paragraph8_3":"SDEs wanting to learn System Design",
