export const AiCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Advance Artificial Intelligence Course in Mumbai With",
      mTopPara: "Boost Your Professional Growth ",
      spanMTitleText: " Domain Specialization",
      mTopPara1: "To a Whole New Level",
      title: "Advance Artificial Intelligence Course in Mumbai",
    ...
    BoxShape: {
    title: "AI Certification Programs in Mumbai",
  ...
  syllabusDesc:"Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Artificial Intelligence Course in Mumbai sessions are covered practically with real-time industrial projects and case studies.",
  ...
  ProgramFee: {
    Emi: "₹ 9,342/month",
    Fee: "₹ 95,000 +GST",
    CourseFeeAndFinancing:"Artificial Intelligence Course Fee & Financing in Mumbai",
    para:"We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for AI Certification Course in Mumbai and offer avariety of financing options to make it more economical.",
  },
