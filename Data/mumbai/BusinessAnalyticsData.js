export const BusinessAnalyticsCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Business Analytics Course in Mumbai",
      spanMTitleText: "For Professionals",
      title: "Business Analytics Course in Mumbai",
    ...
    BoxShape: {
      title: "Business Analytics Certification Programs in Mumbai",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Business Analytics Course in Mumbai sessions are covered practically with real-time industrial projects and case studies.",
    ...
    ProgramFee: {
      ...
      CourseFeeAndFinancing:
        "Business Analytics Course Fee & Financing in Mumbai",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Business Analytics Certification Course in Mumbai and offer a variety of financing options to make it more economical.",
    },
    Project: {
    ...
    CourseFees: {
      CourseFeeHead: "Business Analytics Course in Mumbai : Batch Details",
