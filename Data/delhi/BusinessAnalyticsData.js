export const BusinessAnalyticsCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Business Analytics Course in Delhi",
      spanMTitleText: "For Professionals",
      title: "Business Analytics Course in Delhi",
    ...
    BoxShape: {
      title: "Business Analytics Certification Programs in Delhi",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Business Analytics Course in Delhi sessions are covered practically with real-time industrial projects and case studies.",
    ...
    ProgramFee: {
      ...
      CourseFeeAndFinancing:
        "Business Analytics Course Fee & Financing in Delhi",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Business Analytics Certification Course in Delhi and offer a variety of financing options to make it more economical.",
    },
    Project: {
    ...
    CourseFees: {
      CourseFeeHead: "Business Analytics Course in Delhi : Batch Details",
