export const MlCourseData = [
  ...
  syllabusDesc:"Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Machine Learning Course in Delhi sessions are covered practically with real-time industrial projects and case studies.",
  ...
  ProgramFee: {
    Emi: "₹ 9,342/month",
    Fee: "₹ 95,000 +GST",
    CourseFeeAndFinancing:" Machine Learning Course Fee & Financing in Delhi",
  ...
  Project: { project: "15+ Projects", domain: "7+", projectTitle:"Hands-on Projects in Delhi"},
  CourseFee: {
