export const DataScienceCourseData = [
  {
    ...
    BoxShape: {
      title: "Data Science Certification Programs in Delhi",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Data Science Course In Delhi sessions are covered practically with real-time industrial projects and case studies.",
    popupHead: "Download Brochure",
    hours: "250+ Hours",
    ...
    ProgramFee: {
      Fee: "₹95,000 + GST",
      Emi: "₹ 9,341/month",
      CourseFeeAndFinancing: "Data Science Course Fee & Financing In Delhi",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Data Science Certification Course In Delhi and offer avariety of financing options to make it more economical.",
    },
    Project: {
    ...
    CourseFees: {
      CourseFeeHead: "Data Science Course In Delhi : Batch Details",
