export const MlCourseData = [
  {
    ...
    BoxShape: {
    title: "Machine Learning Certification Programs in Bangalore",
  ...
  syllabusDesc:"Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Machine Learning Course in Bangalore sessions are covered practically with real-time industrial projects and case studies.",
  popupHead: "Download Data science Course Brochure",
  hours: "350+ Hours",
  project: "15+ Real Time",
  CSyllabus:"Machine Learning Course Syllabus",
  CourseHighlights:" Machine Learning Course Highlights",
  syllabus: [
    {
      Module0: {
  ...
  ProgramFee: {
    Emi: "₹ 9,342/month",
    Fee: "₹ 95,000 +GST",
    CourseFeeAndFinancing:" Machine Learning Course Fee & Financing in Bangalore",
    para:"We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Machine Learning Certification Course in Bangalore and offer avariety of financing options to make it more economical.",

  },
  Project: { project: "15+ Projects", domain: "7+", projectTitle:"Hands-on Projects in Bangalore"},
  CourseFee: {
    CourseFeeHead: "Machine Learning Course in Bangalore : Batch Details",
