export const BusinessAnalyticsCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Business Analytics Course in Bangalore",
    ...
    BoxShape: {
      title: "Business Analytics Certification Programs in Bangalore",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Business Analytics Course in Bangalore sessions are covered practically with real-time industrial projects and case studies.",
    ...
    CourseFees: {
      CourseFeeHead: "Business Analytics Course in Bangalore : Batch Details",
