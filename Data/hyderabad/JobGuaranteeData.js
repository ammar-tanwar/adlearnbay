export const JobGuaranteeCourseData = [
  {
    FirstSection: {
      ...
      title: "Data Science and AI Program in Hyderabad ",
    ...
    BoxShape: {
      title: "100% Job Assistance Programs in Hyderabad",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All 100% Placement Assistance Course in Hyderabad sessions are covered practically with real-time industrial projects and case studies.",
    ...
    ProgramFee: {
      ...
      CourseFeeAndFinancing:
        "100% Placement Assistance Course Fee & Financing In Hyderabad",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for 100% Placement Assistance Course In Hyderabad and offer avariety of financing options to make it more economical.",
    },
    Project: {
    ...
    CourseFee: {
      CourseFeeHead:
        "100% Placement Assistance Course In Hyderabad: Batch Details",
