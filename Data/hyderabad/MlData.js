export const MlCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Advance Machine Learning Course In Hyderabad",
      mTopPara: "Boost Your Professional Growth ",
      spanMTitleText: "For Professionals",
      mTopPara1: "To a Whole New Level",
      title: " Advance Machine Learning Course In Hyderabad",
    ...
    BoxShape: {
    title: "Machine Learning Certification Programs in Hyderabad",
  ...
  syllabusDesc:"Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Machine Learning Course in Hyderabad sessions are covered practically with real-time industrial projects and case studies.",
  ...
  ProgramFee: {
    Emi: "₹ 9,342/month",
    Fee: "₹ 95,000 +GST",
    CourseFeeAndFinancing:" Machine Learning Course Fee & Financing in Hyderabad",
    para:"We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Machine Learning Certification Course in Hyderabad and offer avariety of financing options to make it more economical.",

  },
  Project: { project: "15+ Projects", domain: "7+", projectTitle:"Hands-on Projects in Hyderabad"},
  CourseFee: {
