export const AiCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Advance Artificial Intelligence Course in Hyderabad With",
      mTopPara: "Boost Your Professional Growth ",
      spanMTitleText: " Domain Specialization",
      mTopPara1: "To a Whole New Level",
      title: "Advance Artificial Intelligence Course in Hyderabad",
    ...
    BoxShape: {
    title: "AI Certification Programs in Hyderabad",
  ...
  syllabusDesc:"Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Artificial Intelligence Course in Hyderabad sessions are covered practically with real-time industrial projects and case studies.",
  ...
  ProgramFee: {
    Emi: "₹ 9,342/month",
    Fee: "₹ 95,000 +GST",
    CourseFeeAndFinancing:"Artificial Intelligence Course Fee & Financing in Hyderabad",
