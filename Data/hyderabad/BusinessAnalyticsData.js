export const BusinessAnalyticsCourseData = [
  {
    FirstSection: {
      ...
      mTitle: "Business Analytics Course in Hyderabad",
      spanMTitleText: "For Professionals",
      title: "Business Analytics Course in Hyderabad",
    ...
    BoxShape: {
      title: "Business Analytics Certification Programs in Hyderabad",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Business Analytics Course in Hyderabad sessions are covered practically with real-time industrial projects and case studies.",
    ...
    CourseFees: {
      CourseFeeHead: "Business Analytics Course in Hyderabad : Batch Details",
