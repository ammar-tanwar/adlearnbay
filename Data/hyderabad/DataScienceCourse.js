export const DataScienceCourseData = [
  {
    ...
    BoxShape: {
      title: "Data Science Certification Programs in Hyderabad",
      ...
      box3desc:
        "Get professionally trained from top product based MNCs and MNC experts",
    ...
    syllabusDesc:
      "Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Data Science Course In Hyderabad sessions are covered practically with real-time industrial projects and case studies.",
    popupHead: "Download Brochure",
    hours: "250+ Hours",
    ...
    ProgramFee: {
      Fee: "₹95,000 + GST",
      Emi: "₹ 9,341/month",
      CourseFeeAndFinancing: "Data Science Course Fee & Financing In Hyderabad",
      para: "We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Data Science Certification Course In Hyderabad and offer avariety of financing options to make it more economical.",
    },
    Project: {
    ...
    CourseFees: {
      CourseFeeHead: "Data Science Course In Hyderabad : Batch Details",
