          ...
          <div className={show ? styles.mobileWrapper : styles.hide}>
            <div className={styles.mobileMenu}>
              <span onClick={showMenu}>
                <Link href="/data-science-certification-courses-s5">Data Science & AI Certification</Link>
              </span>

              <span onClick={showMenu}>
                <Link href="/advance-ai-ml-certification-s5">Advance AI & ML Certification</Link>
              </span>

              <span onClick={showMenu}>
                <Link href="/data-science-ai-cert-for-managers-leaders-s5">Data Science & AI Cert. For Managers & Leaders</Link>
              </span>

              <span onClick={showMenu}>
                <Link href="job-guarantee-or-money-back-data-science-ai-s5">Job Guarantee or Money Back – Data Science & AI</Link>
              </span>
            </div>
          </div>
          <a href="/job-guarantee-or-money-back-data-science-ai-s5">
            <Image
