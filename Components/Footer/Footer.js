    ...
    <section className={styles.FooterSection}>
      <div className={styles.FooterDiv}>
        ...
        <div className={styles.FooterDivInner}>
          ...
          <a href="/dsa"><p className={styles.FooterInnerli} style={{display:"flex"}}><FaCheck className="bIcons"  />DSA & System Design</p></a>
          ...
          <a href="/job-guarantee-or-money-back-data-science-ai"><p className={styles.FooterInnerli} style={{display:"flex"}}><FaCheck className="bIcons"  />Job Guarantee or Money Back - Data Science & AI</p></a>
          </div>
        <div className={styles.FooterDivInner}>
