    ...
    <section className={styles.FooterSection}>
      <div className={styles.FooterDiv}>
        ...
        <div className={styles.FooterDivInner}>
          ...
          <a href="/job-guarantee-or-money-back-data-science-ai-s3d"><p className={styles.FooterInnerli} style={{ display: "flex" }}><FaCheck className="bIcons" />100% Placement Assistance – Data Science & AI</p></a>
        </div>
        <div className={styles.FooterDivInner}>
