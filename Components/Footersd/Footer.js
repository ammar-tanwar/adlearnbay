    ...
    <section className={styles.FooterSection}>
      <div className={styles.FooterDiv}>
        ...
        <div className={styles.FooterDivInner}>
          ...
          <a href="/datascience/data-science-certification-courses-sd">
            <p className={styles.FooterInnerli} style={{ display: "flex" }}>
              <FaCheck className="bIcons" />
              Advance Data Science & AI Certification
            </p>
          </a>
          <a href="/datascience/advance-ai-ml-certification-sd">
            <p className={styles.FooterInnerli} style={{ display: "flex" }}>
              <FaCheck className="bIcons" />
              Advance AI & ML Certification
            </p>
          </a>
          <a href="/datascience/data-science-ai-cert-for-managers-leaders-sd">
            <p className={styles.FooterInnerli} style={{ display: "flex" }}>
              <FaCheck className="bIcons" />
