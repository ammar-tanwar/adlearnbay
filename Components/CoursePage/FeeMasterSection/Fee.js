        ...
        <div className={styles.third}>
          ...
          <div className={styles.boxOrange}>
            ...
            <div className={styles.batches}>
              <p className={styles.date}>DEC 14th</p>
              <div className={styles.Time}>
                <p className={styles.day}>MON - FRI</p>
                <p className={styles.paraBot}>08:00 PM - 10:00 PM</p>
              </div>
            </div>
          </div>
          ...
          <div className={styles.boxOrange}>
              <p>Weekend Batch</p>
            <div className={styles.batches}>
              <p className={styles.date}>NOV 5th</p>
              <div className={styles.Time}>
                <p className={styles.day}>SAT - SUN</p>
                <p className={styles.paraBot}>09:30 AM - 1:00 PM</p>
              </div>
            </div>
          </div>
        </div>
