    ...
    <section className={styles.Syllabus}>
      ...
      <div className={styles.syllabusLeft}>
        <div className={styles.Syllabusbutton}>
          ...
          <div>
            <a href={downloadBrochureLink} target="_blank">
              ...
              <div className={styles.QInner}>
                ...
                >
                  ...
                  {state[5].open ? (
                    <div className={styles.ans}>
                      <li>
                        Linkedin - Build a powerful personal brand on Linkedin
                ...
                >
                  ...
                  {state[6].open ? (
                    <div className={styles.ans}>
                      ...
                      <li>
                        Syntax, Data Types, Variables, Loops, Conditionals and
                        If Statement
                      </li>
                      ...
                      <li>
                        Learn about react js, angular, express, backbone and
                        node js
                      </li>
                      ...
                      <li>
                        Learn JSON & AJAX to connect to APIs and endpoints
                      </li>
                      ...
                      <li>
                        To convert consumer demands and technological trends
                        into product definitions, a cross-functional team will
                        be assembled.
                      </li>
                      <p>
                      ...
                      <li>
                        Gain expertise in CI/CD pipeline development using
                      ...
                      <li>
                        Developing Secure Data Storage and Processing
                        Applications
                      </li>
