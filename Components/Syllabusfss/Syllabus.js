    ...
    <section className={styles.Syllabus}>
      ...
      <div className={styles.syllabusLeft}>
        <div className={styles.Syllabusbutton}>
          ...
          <div>
            <a href="https://brochureslearnbay.s3.ap-south-1.amazonaws.com/Brochures+W/Full+Stack+software+development++(1).pdf" target="_blank"><button className={styles.Button}>
              {" "}
