        ...
        <div >
            ...
            <main>  <Navbar popup={true} formotp={true} />
                ...
                <FirstSection formotp={true}
                    ...
                    spanMTitleText={SytstemDesignCourseData[0].FirstSection.spanMTitleText}
                ...
                <ProgramFee Fee={SytstemDesignCourseData[0].ProgramFee.Fee} Emi={SytstemDesignCourseData[0].ProgramFee.Emi} formotp={true}
                    CourseFeeAndFinancing={SytstemDesignCourseData[0].ProgramFee.CourseFeeAndFinancing}
                ...
                <div className={styles.ProjectWrapper} id="project">
                    <Project project={SytstemDesignCourseData[0].Project.project} domain={SytstemDesignCourseData[0].Project.domain} formotp={true} />
                </div>
                <Batch formotp={true}
                    syllabusDesc={SytstemDesignCourseData[0].syllabusDesc}
                    ...
                    CourseFeelist1={SytstemDesignCourseData[0].BatchCourses.CourseFeelist1}
                    CourseFeelist2={SytstemDesignCourseData[0].BatchCourses.CourseFeelist2}
                    CourseFeelist3={SytstemDesignCourseData[0].BatchCourses.CourseFeelist3}
                    CourseFeelist4={SytstemDesignCourseData[0].BatchCourses.CourseFeelist4}
                    CourseFeelist5={SytstemDesignCourseData[0].BatchCourses.CourseFeelist5}
                />
