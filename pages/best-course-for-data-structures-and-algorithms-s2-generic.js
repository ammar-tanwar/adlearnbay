  ...
  return (
    <div>
      ...
      <main>
        ...
        <FirstSection
          formotp={true}
          deskTopPara={BestDataStructureAlgorithmData[0].FirstSection.deskTopPara}
          mTopPara={BestDataStructureAlgorithmData[0].FirstSection.mTopPara}
          mTitle={BestDataStructureAlgorithmData[0].FirstSection.mTitle}
          spanMTitleText={
            BestDataStructureAlgorithmData[0].FirstSection.spanMTitleText
          }
          title={BestDataStructureAlgorithmData[0].FirstSection.title}
          spanTitleText={
            BestDataStructureAlgorithmData[0].FirstSection.spanTitleText
          }
          desc={BestDataStructureAlgorithmData[0].FirstSection.desc}
          src={BestDataStructureAlgorithmData[0].FirstSection.src}
          width={BestDataStructureAlgorithmData[0].FirstSection.width}
          height={BestDataStructureAlgorithmData[0].FirstSection.height}
          alt={BestDataStructureAlgorithmData[0].FirstSection.alt}
          srcD={BestDataStructureAlgorithmData[0].FirstSection.srcD}
        />
        <div className={styles.program}>
          <ProgramInfo
            p1={BestDataStructureAlgorithmData[0].ProgramInfo.p1}
            p11={BestDataStructureAlgorithmData[0].ProgramInfo.p11}
            p2={BestDataStructureAlgorithmData[0].ProgramInfo.p2}
            p22={BestDataStructureAlgorithmData[0].ProgramInfo.p22}
            p3={BestDataStructureAlgorithmData[0].ProgramInfo.p3}
            p33={BestDataStructureAlgorithmData[0].ProgramInfo.p33}
            p4={BestDataStructureAlgorithmData[0].ProgramInfo.p4}
            p44={BestDataStructureAlgorithmData[0].ProgramInfo.p44}
          />
        </div>
        <div className="Feature" id="Feature">
          <BoxShape
            title={BestDataStructureAlgorithmData[0].BoxShape.title}
            Box1h5={BestDataStructureAlgorithmData[0].BoxShape.Box1h5}
            box1desc={BestDataStructureAlgorithmData[0].BoxShape.box1desc}
            Box2h5={BestDataStructureAlgorithmData[0].BoxShape.Box2h5}
            box2desc={BestDataStructureAlgorithmData[0].BoxShape.box2desc}
            Box3h5={BestDataStructureAlgorithmData[0].BoxShape.Box3h5}
            box3desc={BestDataStructureAlgorithmData[0].BoxShape.box3desc}
            Box4h5={BestDataStructureAlgorithmData[0].BoxShape.Box4h5}
            box4desc={BestDataStructureAlgorithmData[0].BoxShape.box4desc}
            headh5={BestDataStructureAlgorithmData[0].BoxShape.headh5}
          />
        </div>
        <div className={styles.Feature} id="Feature">
          <BoxShape1
            formotp={true}
            title={BestDataStructureAlgorithmData[0].BoxShape1.title}
            Box1h5={BestDataStructureAlgorithmData[0].BoxShape1.Box1h5}
            box1desc={BestDataStructureAlgorithmData[0].BoxShape1.box1desc}
            Box2h5={BestDataStructureAlgorithmData[0].BoxShape1.Box2h5}
            box2desc={BestDataStructureAlgorithmData[0].BoxShape1.box2desc}
            Box3h5={BestDataStructureAlgorithmData[0].BoxShape1.Box3h5}
            box3desc={BestDataStructureAlgorithmData[0].BoxShape1.box3desc}
            Box4h5={BestDataStructureAlgorithmData[0].BoxShape1.Box4h5}
            box4desc={BestDataStructureAlgorithmData[0].BoxShape1.box4desc}
          />
        </div>
        ...
        <SyllabusNew
          ...
          syllabus={BestDataStructureAlgorithmData[0].syllabus}
          syllabusDesc={BestDataStructureAlgorithmData[0].syllabusDesc}
          popupHead={BestDataStructureAlgorithmData[0].popupHead}
          CSyllabus={BestDataStructureAlgorithmData[0].CSyllabus}
          CourseHighlights={BestDataStructureAlgorithmData[0].CourseHighlights}
          srcD={BestDataStructureAlgorithmData[0].srcD}
          hours={BestDataStructureAlgorithmData[0].hours}
          project={BestDataStructureAlgorithmData[0].project}
        />
        <ProgramFee
          ...
          CourseFeeAndFinancing={
            BestDataStructureAlgorithmData[0].ProgramFee.CourseFeeAndFinancing
          }
        ...
        <div className={styles.ProjectWrapper} id="project">
          <Project
            project={BestDataStructureAlgorithmData[0].Project.project}
            domain={BestDataStructureAlgorithmData[0].Project.domain}
            formotp={true}
          />
        </div>
        <Batch
          ...
          CourseFeeHead={
            BestDataStructureAlgorithmData[0].BatchCourses.CourseFeeHead
          }
          CourseFeePara={
