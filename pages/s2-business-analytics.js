    ...
    <div>
      ...
      <main>  <Navbar popup={true} />
        ...
        <FirstSection
          ...
          spanTitleText={BusinessAnalyticsCourseData[0].FirstSection.spanTitleText}
          mTitle={BusinessAnalyticsCourseData[0].FirstSection.mTitle}
          mTopPara={BusinessAnalyticsCourseData[0].FirstSection.mTopPara}
          spanMTitleText={BusinessAnalyticsCourseData[0].FirstSection.spanMTitleText}
        ...
        <div className="Feature" id="Feature">
          <BoxShape
            ...
            headh5="Watch our alumni’s making successful Business Analytics career transition"
        ...
        <ProgramFee Emi={BusinessAnalyticsCourseData[0].ProgramFee.Emi}
          ...
          CourseFeeAndFinancing={BusinessAnalyticsCourseData[0].ProgramFee.CourseFeeAndFinancing}
