...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>
          Data Science Certification course - Learnbay
        </title>
        <meta
          name="description"
      ...
      <main>  <Navbar popup={true} />
        ...
        <FirstSection
          ...
          mTitle="Data Science Certification Course "
        ...
        <div className={styles.Feature} id="Feature">
          <BoxShape
            ...
            headh5="Watch our alumni’s making successful Certified Data Science career transition"
          />
        </div>
        ...
        <SyllabusNew
          ...
          CSyllabus="Data Science Certification Course Syllabus"
          CourseHighlights="Data Science Course Highlights"
          syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Data Science Certification Course sessions are covered practically with real-time industrial projects and case studies."
          popupHead={DataScienceCourseData[0].popupHead}
          hours={DataScienceCourseData[0].hours}
          project={DataScienceCourseData[0].project}
        />
        <OurExpert
          H5="Data Science Course Tools Covered"
        ...
        <ProgramFee Fee={DataScienceCourseData[0].ProgramFee.Fee}
          Emi={DataScienceCourseData[0].ProgramFee.Emi} CourseFeeAndFinancing="Data Science Certification Course Fee & Financing"
        ...
        <CourseFee
          ...
          CourseFeeHead="Certified Data Science Course : Batch Details"
