  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Learn Software Programming Course. Get a chance to work with top product based MNCs Companies and participate in live, interactive online sessions led by tech experts to gain real-time project experience."
        />
        <meta
          name="Keywords"
          content="Software Programming Course, Online Software Programming Course, Live Software Programming Course, Learn Software Programming Course, Best Software Programming Course"
        />
        <script
 ...
 "messageText":"I am looking for course, and free career counselling session.",
      ...
      <main>
        ...
        <HeroSection
          ...
          para="#1 Software Programming Course for Top Product Based MNC’s"
        ...
        <ProgramFee
          ...
          para="We are dedicated to making our Software Programming Course accessible. We are committed to helping you find a way to budget for this Course and offer a variety of financing options to make it more economical."
          dataScience={true}
        />
        <Batch
          formotp={true}
