  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Learn Full Stack Software Development. Get a chance to work with top product based MNCs Companies and participate in live, interactive online sessions led by tech experts to gain real-time project experience."
        />
        <meta
          name="Keywords"
 ...
 "messageText":"I am looking for course, and free career counselling session.",
      ...
      <main>
        ...
        <HeroSection
          ...
          h1="Full Stack Software Development Program"
        ...
        <FourthSection
          fullStackCont={true}
          h1="Full Stack Software Development Program Highlights"
        ...
        <SyllabusSection
          fullStackCont={true}
          formotp={true}
          desc="Learnbay offers Full Stack Software Development Program led by experts working in top MNCs & real-time industrial projects with case studies."
          Hours="300+ Hours"
        ...
        <ProgramFee
          ...
          formotp={true}
          CourseFeeAndFinancing="Full Stack Software Development Institute Fee & Financing"
          para="We are dedicated to making our Full Stack Software Development Institute accessible.  We are committed to helping you find a way to budget for this Course and offer a variety of financing options to make it more economical."
          dataScience={true}
        />
        <Batch
          formotp={true}
