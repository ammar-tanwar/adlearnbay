                ...
                <div className={styles.boxContent}>
                    ...
                    <div>
                        <div className={styles.InnerBox}>
                            <p className={styles.SecondP}>Most product based companies looks at how great your DSA skills are and how you use it on a daily basis to solve problems and for the you require to learn DSA course</p>
                        </div>
                        <div className={styles.InnerBox}>
                            <p className={styles.SecondP}>Data Structure course can help one to understand how to apply the right data structures and that it is an important step in managing your data well and writing efficient code.</p>
                        </div>
                        <div className={styles.InnerBox}>
