...
export default function Home() {
  ...
  return (
    <>
      <div>
        <Head>
          <title>Machine Learning Advance Course – Learnbay</title>
          <meta
            name="description"
 ...
 "messageText":"I am looking for course, and free career counselling session.",
        ...
        <main>
          ...
          <FirstSection
            ...
            mTitle="Advance Machine Learning Course"
            title="Advance Machine Learning Course"
          ...
          <div className="Feature" id="Feature">
            <BoxShape
              formotp={true}
              title="Explore Our Advance Machine Learning Certification Programs"
          ...
          <SyllabusNew
            ...
            CSyllabus="Advance Machine Learning Course Syllabus"
            CourseHighlights={MlCourseData[0].CourseHighlights}
            syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Advance Machine Learning Course sessions are covered practically with real-time industrial projects and case studies."
          ...
          />
          <OurExpert
            H5="Advance Machine Learning Tools Covered"
