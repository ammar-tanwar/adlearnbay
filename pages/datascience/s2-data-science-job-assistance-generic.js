...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Data Science Course with 100% Job Assistance</title>
        <meta
          name="description"
        ...
        <meta
          name="Keywords"
          content="Data  analytics Course with 100% Job Assistance, Data Science online Course with 100% Job Assistance, Best online Data Science Course with 100% Job Assistance, online Data Science Course with 100% Job Assistance, Data Science Course with 100% Job Assistance for working professionals, Data analytcis Course with 100% Job Assistance fee, Data Science Course with 100% Job Assistance duration"
        />
        <link
          rel="icon"
 ...
 "messageText":"I am looking for course, and free career counselling session.",
      ...
      <main>
        ...
        <SyllabusSection
          formotp={true}
          s2dataScience={true}
          desc="Learnbay offers live, interactive online sessions with professionals from top MNCs. Our Data Science Course with 100% Job Assistance feature practical training with real-time projects and case studies."
          Hours="200+ Hours"
          Projects="8+ projects"
