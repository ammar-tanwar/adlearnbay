...
export default function Home() {
  ...
  return (
    <>
      <div>
        <Head>
          <title>Online Data Science Training</title>
          <meta
            name="description"
            content="Want to earn salary hike of 250% ? Our Data Science training 
 will boost salary. Apply Now!"
          />

          <meta
            name="Keywords"
            content="data science training, data science training for working professional, data science training fee, data science training duration, data science training syllabus, data science online training"
          />
 ...
 "messageText":"I am looking for course, and free career counselling session.",
        ...
        <main>
          ...
          <SyllabusSection
            formotp={true}
            s2dataScience={true}
            desc="Learnbay offers live, interactive online sessions with professionals from top MNCs. Our data science training feature practical training with real-time projects and case studies."
            Hours="250+ Hours"
