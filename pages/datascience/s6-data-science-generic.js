...
export default function Home() {
 ...
 "messageText":"I am looking for course, and free career counselling session.",
        ...
        ></script> */}
          ...
          dangerouslySetInnerHTML={{
            __html: ` { (function (botId) { var s = document.createElement("script"); s.async = true; s.type =
'text/javascript'; s.src = "https://app.chat360.io/widget/chatbox/common_scripts/script.js"; s.onload =
function () { window.loadChat360Bot(botId); }; s.onerror = function (err) { console.error(err); };
document.body.appendChild(s); })("f0e8b4af-17cc-4455-b14c-fd50202e7c9b"); } `,
          }}
        />
      </Head>
      <main>
