...
export default function Home() {
  ...
  return (
    <>
      <div>
        <Head>
          <title>Data Analytics Course with 100% Job Assistance</title>
          <meta
            name="description"
          ...
          <meta
            name="Keywords"
            content="Data  analytics Course with 100% Job Assistance, Data analytics online Course with 100% Job Assistance, Best online Data analytics Course with 100% Job Assistance, online Data analytics Course with 100% Job Assistance, Data analytics Course with 100% Job Assistance for working professionals, Data analytcis Course with 100% Job Assistance fee, Data analytics Course with 100% Job Assistance duration"
          />
          <link
            rel="icon"
 ...
 "messageText":"I am looking for course, and free career counselling session.",
        ...
        <main>
          ...
          <HeroSection
            ...
            h1="Data Analytics Course with"
            hSpan="100% Job Assistance"
            para="Course based on real-time projects specially designed for working professionals who aspire of having a lucrative career."
          ...
          <SyllabusSection
            formotp={true}
            s2dataScience={true}
            desc="Learnbay offers live, interactive online sessions with professionals from top MNCs. Our data analytics Course with 100% Job Assistance feature practical training with real-time projects and case studies."
            Hours="200+ Hours"
            Projects="8+ projects"
