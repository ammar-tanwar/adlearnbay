...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Online Machine Learning Certification Course</title>
        <meta
          name="description"
          content="Top Online Machine Learning Certification Course with 
          100% Placement assistance"
        />

        <meta
          name="Keywords"
          content="Certification Course in machine learning, ml Certification Course, machine learning Certification Course, Certification Course in ml online, machine learning Certification Course, Best machine learning Certification Course, machine learning online Certification Course"
        />
 ...
 "messageText":"I am looking for course, and free career counselling session.",
      ...
      <main>
        ...
        <HeroSection
          ...
          h1="Machine Learning Certification Course"
        ...
        <SecondSection
          ...
          p2="5-star"
          p22="Industry-standard Certification Course"
          p3="3-year"
        ...
        <SyllabusSection
          formotp={true}
          s2dataScience={true}
          desc="Learnbay offers live, interactive online sessions with professionals from top MNCs. Our machine learning certification course feature practical Certification Course with real-time projects and case studies."
          Hours="350+ Hours"
