...
export default function Home() {
  ...
  return (
    <>
      <div>
        <Head>
          <title>Learn Online Master in Artificial and Machine Learning</title>
          <meta
            name="description"
            content="Top Master in Artificial and Machine Learning with Domain specialization and
get 100% placement assistance "
          />

          <meta
            name="Keywords"
            content="Master in Artificial and Machine Learning, ai course, online ai course, Master in Artificial and Machine Learning online, ai course fee, ai course duration, Master in Artificial and Machine Learning fee, Master in Artificial and Machine Learning duration"
          />
          <link
            rel="icon"
 ...
 "messageText":"I am looking for course, and free career counselling session.",
        ...
        <main>
          ...
          <HeroSection
            ...
            h1="Master in Artificial and Machine Learning"
          ...
          <SyllabusSection
            formotp={true}
            s2dataScience={true}
            desc="Learnbay offers live, interactive online sessions with professionals from top MNCs. Our Master in Artificial and Machine Learning feature practical training with real-time projects and case studies."
            Hours="350+ Hours"
