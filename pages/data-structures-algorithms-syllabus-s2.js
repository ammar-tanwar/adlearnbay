  ...
  return (
    <div>
      ...
      <title>Data Structure Course Syllabus</title>
        ...
        <meta
          name="Keywords"
          content="Data Structures Syllabus, Dsa Syllabus, Data Structures Course Syllabus, Dsa Course Syllabus, Download Dsa Course Syllabus, Checkout Data Structures Course Syllabus"
        />
        <link
          rel="icon"
      ...
      <main>
        ...
        <HeroSection
          ...
          para="Learn Advance Topics like Strings, Arrays, Trees and so more, with our Course"
        ...
        <ProgramFee
          ...
          para="We are dedicated to making our Data Structures and Algorithms Course accessible. We are committed to helping you find a way to budget for this program and offer a variety of financing options to make it more economical."
          dataScience={true}
        />
        <Batch
          formotp={true}
