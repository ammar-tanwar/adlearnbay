...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Machine Learning Master Course – Learnbay</title>
        <meta
          name="description"
      ...
      <main>  <Navbar popup={true} />
        ...
        <FirstSection
          ...
          mTitle="Machine Learning Master Course"
        ...
        <div className="Feature" id="Feature">
          <BoxShape
            title="Explore Our Machine Learning Master Programs"
            ...
            headh5="Watch ours alumni’s making successful Machine Learning Master career transition"
          />
        </div>
        <CourseReview
          p1="Working at HCL"
        ...
        <Certificate
          H4="Machine Learning Master Program" />
        <OtherCertificate
        ...
        <SyllabusNew
          ...
          CSyllabus="Machine Learning Master Course Syllabus"
          CourseHighlights={MlCourseData[0].CourseHighlights}
          syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Machine Learning Master Course sessions are covered practically with real-time industrial projects and case studies."
        ...
        />
        <OurExpert
          H5="Machine Learning Master Tools Covered"
        ...
        <ProgramFee Emi={MlCourseData[0].ProgramFee.Emi}
          Fee={MlCourseData[0].ProgramFee.Fee} CourseFeeAndFinancing=" Machine Learning Master Course Fee & Financing"
          para="We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Machine Learning Master Course and offer avariety of financing options to make it more economical." />
        <SliderTab />
        ...
        <CourseFee
          ...
          CourseFeeHead="Machine Learning Master Course : Batch Details"
          CourseFeePara="Machine Learning Master Online Classroom"
