...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Artificial Intelligence Placement Assistance Course - Learnbay</title>
        <meta
          name="description"
      ...
      <main>  <Navbar popup={true} />
        ...
        <FirstSection
          ...
          mTitle="Artificial Intelligence Job Assistance Course -"
          title="Artificial Intelligence Job Assistance Course"
        ...
        <div className="Feature" id="Feature">
          <BoxShape
            title="Explore Our Artificial Intelligence Placement Programs"
        ...
        <Certificate
          H4="AI Placement Assistance Program"
        />
        <OtherCertificate
        ...
        <SyllabusNew
          ...
          CSyllabus="Artificial Intelligence Placement Assistance Course Syllabus"
          CourseHighlights={AiCourseData[0].CourseHighlights}
          syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Artificial Intelligence Placement Assistance Course sessions are covered practically with real-time industrial projects and case studies."
        ...
        <ProgramFee Emi={AiCourseData[0].ProgramFee.Emi}
          Fee={AiCourseData[0].ProgramFee.Fee} CourseFeeAndFinancing="Artificial Intelligence Placement Course Fee & Financing"
          para="We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for AI Placement Assistance Course and offer avariety of financing options to make it more economical." />
        <SliderTab />
        ...
        <CourseFee
          ...
          CourseFeeHead="Artificial Intelligence Placement Assistance Course : Batch Details"
          CourseFeePara="Artificial Intelligence Placement Assistance Online Classroom"
