...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Data Analytics Master course – Learnbay</title>
        <meta
          name="description"
      ...
      <main>
        ...
        <SyllabusNew
          ...
          syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All  Data Analytics Master Course sessions are covered practically with real-time industrial projects and case studies."
