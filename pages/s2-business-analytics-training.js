 ...
 "messageText":"I am looking for course, and free career counselling session.",
        ...
        <main>
          ...
          <FirstSection
            formotp={true}
            deskTopPara={
              BusinessAnalyticsCourseData[0].FirstSection.deskTopPara
            }
            deskTopPara1={
              BusinessAnalyticsCourseData[0].FirstSection.deskTopPara1
            }
            spanTitleText="For Professionals"
            mTitle="Business Analytics Training "
          ...
          <div className="Feature" id="Feature">
            <BoxShape
              ...
              headh5="Watch our alumni making successful Business Analytics Training career transition"
            />
          </div>
          <CourseReview
            formotp={true}
          ...
          <SyllabusNew
            ...
            syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Business Analytics Training sessions are covered practically with real-time industrial projects and case studies."
          ...
          <ProgramFee
            ...
            para="We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Business Analytics Training and offer avariety of financing options to make it more economical."
          />
          ...
          <CourseFee
            ...
            CourseFeePara="Business Analytics Training Online Classroom"
            CourseFeelist1={
