  ...
  return (
    <div>
      <Head>
        ...
        <meta name="Keywords" content="machine learning training, machine learning training, machine learning training institute, machine learning online training, machine learning training  fee, advanced ml training certification, machine learning training for working professional, advanced machine learning training certification, advanced ml training" />
      ...
      <main>  <Navbar popup={true} />
        ...
        <div className="Feature" id="Feature">
          <BoxShape
            ...
            headh5="Watch ours alumni’s making successful Machine Learning Training career transition"
          />
        </div>
        <CourseReview
          p1="Working at HCL"
        ...
        <Certificate
          H4="Machine Learning Training Program" />
        <OtherCertificate
        ...
        <ProgramFee Emi={MlCourseData[0].ProgramFee.Emi}
          Fee={MlCourseData[0].ProgramFee.Fee} CourseFeeAndFinancing=" Machine Learning Training Fee & Financing"
