...
export default function Home() {
  ...
  return (
    <>
      <div>
        <Head>
          <title>Advance Business Analytics course – Learnbay</title>
          <meta
            name="description"
 ...
 "messageText":"I am looking for course, and free career counselling session.",
        ...
        <main>
          ...
          <SyllabusNew
            ...
            syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Advance Business Analytics Course sessions are covered practically with real-time industrial projects and case studies."
          ...
          />
          <OurExpert
            H5="Advance Business Analytics Tools Covered"
