...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Data Analytics Advance course – Learnbay</title>
        <meta
          name="description"
      ...
      <main>  <Navbar popup={true} />
        ...
        <FirstSection
          ...
          mTitle="Advance Data Analytics Course"
          spanMTitleText="For Working Professionals"
          title="Advance Data Analytics Course"
        ...
        <div className="Feature" id="Feature">
          <BoxShape
            ...
            headh5="Watch our alumni’s making successful Advance Data Analytics career transition"
          />
        </div>
        <CourseReview
          p1="Working at HCL"
        ...
        <SyllabusNew
          ...
          CSyllabus="Advance Data Analytics Course Syllabus"
          CourseHighlights={DataAnalyticsCourseData[0].CourseHighlights}
          syllabusDesc="Learnbay provides Live, Interactive Online Sessions guided by Professionals working in top MNCs. All Advance Data Analytics Course sessions are covered practically with real-time industrial projects and case studies."
        ...
        <ProgramFee Emi={DataAnalyticsCourseData[0].ProgramFee.Emi}
          ...
          CourseFeeAndFinancing="Advance Data Analytics Course Fee & Financing"
          para="We are dedicated to making our programs accessible. We are committed to helping you find a way to budget for Advance Data Analytics Certification Course and offer avariety of financing options to make it more economical." />
        ...
        <CourseFee
          ...
          CourseFeeHead="Advance Data Analytics Course : Batch Details"
          CourseFeePara="Advance Data Analytics Online Classroom"
