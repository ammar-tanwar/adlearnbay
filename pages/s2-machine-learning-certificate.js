  ...
  return (
    <div>
      <Head>
        ...
        <meta name="Keywords" content="machine learning Certificate course, machine learning Certificate training,Certification in machine learning, machine learning online Certificate course, machine learning Certificate course fee, advanced ml certification, machine learning Certificate course for working professional, advanced machine learning certification, advanced ml Certificate courses" />
      ...
      <main>  <Navbar popup={true} />
        ...
        <div className="Feature" id="Feature">
          <BoxShape
            ...
            headh5="Watch ours alumni’s making successful Machine Learning Certificate career transition"
          />
        </div>
        <CourseReview
          p1="Working at HCL"
        ...
        <Certificate
          H4="Machine Learning Certificate Program" />
        <OtherCertificate
        ...
        <ProgramFee Emi={MlCourseData[0].ProgramFee.Emi}
          Fee={MlCourseData[0].ProgramFee.Fee} CourseFeeAndFinancing=" Machine Learning Certificate Course Fee & Financing"
